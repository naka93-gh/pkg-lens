...
import { getOutdated, getAudit, getDependencyTree, searchRegistry } from "./svc/npm.svc";
...
export function registerIpcHandlers(): void {
  ...
  ipcMain.handle("get-dependency-tree", (_e, dir: string) => getDependencyTree(dir));
  ipcMain.handle("search-registry", (_e, query: string) => searchRegistry(query));
